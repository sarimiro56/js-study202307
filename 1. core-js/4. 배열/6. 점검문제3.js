...
// while (true) {
//     let cname = prompt(`[${nameList}]\n수정할 멤버 이름을 입력하세요.`);
//     let index = nameList.indexOf(cname);
//     if (index > -1) {
//         let rname = prompt(`수정할 이름은 무엇인가요?`);
//         nameList[index] = rname;
//     }
//     else if (index != nameList) {
//         alert(`${cname}는(은) 잘못된 이름입니다.`);
//     }
// }